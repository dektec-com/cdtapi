...
// The MAC address to send to Dst from Own: a multicast group's own, the broadcast address
...
// Joins Group on the socket: from any source without sources or for an all-zero one, and
