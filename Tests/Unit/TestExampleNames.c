...
//
// CDTAPI - Unit tests for the names the example programs give video standards
//
// SPDX-License-Identifier: BSD-3-Clause
//
// VidStdCodes.inc is generated by CMake from cdtapi_constants.h, one V(Macro) per
